...
public class HorizontalSquaresPattern extends MantisPattern {
    ...
    public HorizontalSquaresPattern(LX lx) {
        super(lx);
...
//        s.yn = s.yMin;
    ...
    public class Square {
        ...
        public void updatePosition(double currentTime) {
            this.xn = this.xMin + this.xRange * (float)((currentTime - startTime) / lifeTime);
        }
